...
import { sampleWithRequiredData } from '../service-order.test-samples';
...
describe('ServiceOrder Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.serviceOrders()[0]).toEqual(expect.objectContaining({ id: 9582 }));
  });

  describe('trackId', () => {
    it('Should forward to serviceOrderService', () => {
      const entity = { id: 9582 };
      jest.spyOn(service, 'getServiceOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getServiceOrderIdentifier).toHaveBeenCalledWith(entity);
